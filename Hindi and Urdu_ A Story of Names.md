...
And they were successful: many of the language textbooks created to teach British officers local languages became quite famous, especially the ones for Hindustani (that is, Persianized Hindustnai, or Urdu) prose.[^59] All in all, up to 60 instructional books were published for the British servants and officers who needed to learn Hindustani. Script just was not a central issue yet,[^60] and so some were printed in the Perso-Arabic script, some in the Nagari script.[^61]
...
So in a sense, Gilchrist was doubly successful in his goal to develop Hindustani prose. That is, *two* literary standards had been developed: Hindi, purged of Persian words, and Urdu, a Persianized style.[^64]
...
This gave Hindu ideologues a good explanation for the current state of affairs as well as the repressed memories of 1857-8. The Hindus could remove themselves from the defeat that had just occurred – in their view, everything that happened was because of the centuries of Muslim rule.[^83]
...
*Sh'r* 1: First line: Persian. Second line: first three words Persian, then an Urdu verb, then the last two words Persian of a construction not used in Urdu at all.
*Sh'r* 2. First line: Persian. Second line: first word an Urdu verb, the rest Persian, but such that it could pass for Urdu.
*Sh'r* 3. First line: Persian. Second line: first three words Persian, then an Urdu verb, then the last two words Persian of a construction not used in Urdu at all.
*Sh'r* 4. First line: could pass for Urdu because it has an Urdu verb; the rest Persian, but assimilable in Urdu. Second line: the first word a Persian verb, the rest Persian, but assimilable in Urdu.
*Sh'r* 5. First line: Persian. Second line: the first four words Urdu, followed by a two-word Persian  construction not used in Urdu at all.
*Sh'r* 6. First line: Persian. Second line: Urdu.
*Sh'r* 7. First line: Persian. Second line: Urdu.
*Sh'r* 8. First line: a Persian verb followed by an Urdu construction, then the last two words Persian, but assimilable in Urdu. Second line: Persian.
*Sh'r* 9. First line: Urdu. Second line: Persian.
*Sh'r* 10. First line: Urdu. Second line: Persian.
